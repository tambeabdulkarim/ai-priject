...
const COPY = {
  ar: {
    ...
    empty: 'لا توجد شهادات بعد. أكمل دورة للحصول على شهادتك الأولى.',
    issued: 'صدرت في',
  },
  en: {
    ...
    empty: 'No certificates yet. Complete a course to earn your first one.',
    issued: 'Issued',
  },
} as const;
          ...
          {data?.items.map((certificate) => (
            ...
            >
              ...
              <div className="ph-catalogue-card-meta">
                <span>{t.issued} {new Date(certificate.issuedAt).toLocaleDateString(locale)}</span>
              </div>
            </Link>
          ))}
        </div>
