...
export const dictionaries = {
  ar: {
    ...
    hero: {
      ...
      description:
        'أطلق رحلتك في إدارة المهام والتخطيط مع واجهة احترافية مصممة لتسريع الإنتاجية وتوحيد العمل.',
  ...
  en: {
    ...
    hero: {
      ...
      description:
        'Launch your workflow with a polished experience for task management, planning, and daily execution.',
      ...
      items: [
        {
          ...
          description: 'Keep daily tasks in order through a simple and focused workspace.',
        },
        {
          title: 'Fast collaboration',
          description: 'Share work with your team without losing clarity or momentum.',
        },
        {
          title: 'Clear progress',
          description: 'Track achievements and performance in a single glance.',
        },
      ],
    },
    footer: {
    ...
    dashboard: {
      ...
      description:
        'A focused workspace that helps you organize priorities, tasks, and momentum clearly.',
      focus: 'Current focus',
